function out = dataRead(maxReadQuantum, lineTerminator, sampleFreq, baudRate, portSpec, specialSettings)
tic
delete(instrfindall);
tstart = GetSecs();
sample = 10;
...
% Assign an interbyte readtimeout which is either 5 seconds, or 10 times
...
% 5 seconds if something goes wrong with the connection:
readTimeout = max(10 * 1/sampleFreq, 5);
